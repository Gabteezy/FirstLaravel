            ...
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                @if (Route::has('login'))
                    <nav class="-mx-3 flex flex-1 justify-end">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="rounded-md px-3 py-2 text-white ring-1 ring-transparent transition focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white
                                        hover:bg-gray-300 hover:text-black/70">
                                Log in
                            </a>
